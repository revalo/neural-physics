...
class World(object):
    def __init__(self, width=500, height=500, gravity=(0, 0), wall_elasticity=0.8):
        ...
        self.add_entity(Wall((self.width + 5, self.height / 2), 10, self.height, wall_elasticity))
        self.add_entity(Wall((self.width / 2, -5), self.width, 10, wall_elasticity))
        self.add_entity(Wall((self.width / 2, self.height + 5), self.width, 10, wall_elasticity))
